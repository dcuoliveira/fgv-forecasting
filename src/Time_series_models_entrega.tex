...
\begin{quote}
\textbf{(c)} Heteroskedasticity tests: \textgreater{} \textbf{(i)} White
test
\end{quote}

\begin{quote}
\begin{quote}
\textbf{(ii)} Breusch-Pagan-Godfrey test
\end{quote}
\end{quote}

\begin{quote}
\textbf{(d)} Serial correlation tests: \textgreater{} \textbf{(i)}
...
\includegraphics{Time_series_models_entrega_files/figure-latex/unnamed-chunk-1-1.pdf}
